...
use crate::{
    ...
    core::{
        api::{email::SendInterestsCuponEmail, interests::get_all_interests},
        models::interest::Interest,
        utils::leptos::{LeptosMemberCupon, LeptosSelectableInterest},
    },
};
...
#[component]
pub fn CategoryCuponEmails() -> impl IntoView {
    ...
    let send_emails_action = ServerAction::<SendInterestsCuponEmail>::new();
                                        ...
                                        <div class="mt-3 flex flex-col gap-2 w-full">
                                            ...
                                            <button class="btn btn-success w-full"
                                                on:click={ move |_|{
                                                    ...
                                                    send_emails_action.dispatch(SendInterestsCuponEmail { interests, cupon_description: model.cupon.description, cupon_expires_at: model.cupon.expires_at, subject: model.email.subject, original_body: model.email.body });
                                                }}
                                            >"Enviar"</button>
                                        </div>
                                    }.into_any()
